...
namespace TUIO {
	...
	public:
		...
		TuioObject (TuioTime ttime, long si, int sym, float xp, float yp, float zp, float a):TuioContainer(ttime, si, xp, yp, zp) {
			symbol_id = sym;
			angle = a;
			rotation_speed = 0.0f;
			rotation_accel = 0.0f;
		...
		TuioObject (long si, int sym, float xp, float yp, float zp, float a):TuioContainer(si, xp, yp, zp) {
			symbol_id = sym;
			angle = a;
			rotation_speed = 0.0f;
			rotation_accel = 0.0f;
