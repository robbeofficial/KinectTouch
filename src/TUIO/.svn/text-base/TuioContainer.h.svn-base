...
namespace TUIO {
	...
	public:
		 ...
		 */
		TuioContainer (TuioTime ttime, long si, float xp, float yp, float zp=0):TuioPoint(ttime, xp,yp,zp) {
			session_id = si;
			x_speed = 0.0f;
			y_speed = 0.0f;
			z_speed = 0.0f;
		 ...
		 * @param	yp	the Y coordinate to assign
		 */
		TuioContainer (long si, float xp, float yp, float zp=0):TuioPoint(xp,yp,zp) {
			session_id = si;
			x_speed = 0.0f;
			y_speed = 0.0f;
			y_speed = 0.0f;
		 ...
		 * @param	yp	the Y coordinate to assign
		 */
		virtual void update (TuioTime ttime, float xp, float yp, float zp = 0) {
